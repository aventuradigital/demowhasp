  ...
  return (
    ...
    >
      ...
      <Typography className={classes.elementMargin} component="div">
        ...
        <ul>
          <li>Antes de enviar mensajes, es necesario registrar el token vinculado a la conexión que enviará los mensajes.. <es/>Para registrarse, acceda al menú "Conexiones", haga clic en el botón de edición de la conexión e inserte el token en el campo correspondiente..</li>
          <li>
      ...
      <Grid container>
        <Grid item xs={12} sm={6}>
          <Typography className={classes.elementMargin} component="div">
            ...
            <b>Método: </b> POST <br />
            <b>Headers: </b> X_TOKEN (token cadastrado) e Content-Type (application/json) <es />
      ...
      <Grid container>
        <Grid item xs={12} sm={6}>
          <Typography className={classes.elementMargin} component="div">
            ...
            <b>Endpoint: </b> {getEndpoint()} <br />
            <b>Método: </b> POST <br />
            <b>Headers: </b> X_TOKEN (token cadastrado) e Content-Type (multipart/form-data) <es />
            <b>FormData: </b> <br />
            <ul>
              <li>
