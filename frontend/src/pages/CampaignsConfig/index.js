            ...
            <Grid xs={12} md={4} item>
              ...
              >
                ...
                <Select
                  ...
                  label="Intervalo de disparo aleatorio"
            ...
            <Grid xs={12} md={4} item>
              ...
              >
                <InputLabel id="greaterInterval-label">
                  Intervalo de tiempo de envio
                </InputLabel>
                <Select
                  name="greaterInterval"
                  id="greaterInterval"
                  labelId="greaterInterval-label"
                  label="Intervalo de tiempoi de envio"
